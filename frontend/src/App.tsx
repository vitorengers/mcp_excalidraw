...
function App(): JSX.Element {
   ...
   * `/api/workspaces` has answered there is no list; a single-board install has no registry and
   * never will; and this repository's own board is *called* VibeMaxxing, which would otherwise
   * render `VibeMaxxing — VibeMaxxing`. All three land on the product name alone, which is what
   * `index.html` already said before any of this ran.
   */
  useEffect(() => {
