...
The canvas is [Excalidraw](https://github.com/excalidraw/excalidraw), a separate MIT-licensed
project by the Excalidraw team. It is consumed as an unmodified npm dependency
(`@excalidraw/excalidraw`) and no part of it is vendored or altered here. This project is not
affiliated with the Excalidraw team, and they do not endorse it.

## Upstream assets in this repository

Two things on the front page are the upstream project's rather than this fork's, kept because
they still show what the canvas does, and captioned as upstream's at
