...
const PORT = 37100 + (process.pid % 300);
...
// environment is inherited. A terminal block draws an xterm panel over the board, and it is
// a DOM overlay: a press aimed at the documented block would land on it and be swallowed,
// so section 3 would fail on a coordinate rather than on the feature.
