...
maintainer, [@vitorengers](https://github.com/vitorengers), who is responsible for enforcement:

* open an [issue](https://github.com/vitorengers/vibemaxxing/issues) — appropriate for anything
  that happened in public and can be discussed in public;
* for anything that should not be public, or that concerns the maintainer, use GitHub's
  [report abuse](https://github.com/contact/report-abuse) form, which reaches GitHub Support
  rather than this repository.

This is a single-maintainer project, so there is one person behind both routes and no appeal
body behind them. All complaints will be reviewed and investigated promptly and fairly, and the
privacy and security of the reporter of any incident will be respected.

Vulnerabilities in the software are a different thing and go somewhere else — see
