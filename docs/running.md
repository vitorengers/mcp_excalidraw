...
|---|---|---|---|---|
| `fast` | nothing | Linux, macOS, Windows | 95 | yes |
| `browser` | a Chrome or an Edge to drive | Linux, macOS, Windows | 68 | yes |
...
| `repo` | the full history, and this repository's own board | anywhere with a full clone | 6 | no |
